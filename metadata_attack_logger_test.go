...
func TestAttackMetadataJsonLogger(t *testing.T) {
	logger := NewAttackMetadataJsonLogger(".")
	...
	want = fmt.Sprintf("{\"Type\":\"injection\",\"Flow\":\"1.2.3.4:1-2.3.4.5:2\",\"Time\":\"%s\",\"HijackSeq\":0,\"HijackAck\":0,\"Payload\":\"\",\"Overlap\":\"\",\"StartSequence\":7,\"EndSequence\":77,\"OverlapStart\":3,\"OverlapEnd\":33}\n", timeText)
