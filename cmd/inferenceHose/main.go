...
import (
	...
	"github.com/david415/HoneyBadger/attack/inference"
...
func main() {
	...
	*/
	...
	sideChannel := inference.NewTCPInferenceSideChannel(*iface, int32(*snaplen), targetIP, uint16(*targetPort))
	...
	/*
		injector := inference.NewTCPStreamInjector(patsyIP, targetIP, uint16(*targetPort))
